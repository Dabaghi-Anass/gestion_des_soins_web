...
const ActivityHeader = dynamic(() => import("@/components/activity-header"), {
  ssr: false
})
const ActivityRequestCard = dynamic(() => import("@/components/ui/activity-request-card"), {
  ssr: false
})
...
export default dynamic(() => Promise.resolve(ActivityRequestsPage), {
  ssr: false
})