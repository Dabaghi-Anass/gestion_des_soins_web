...
export default function ProfileBasicinformations() {
  ...
  return <div className="p-4 with-border flex flex-col gap-4 rounded-lg w-full sm:row-span-1 lg:row-span-full">
    ...
    <InfoWithIcon title="Birthday" content={currentUser?.profile?.birthDate || "n/a"} icon={<Cake size={20} />} />
    ...
    <InfoWithIcon title="Age" content={age ? age + "years old" : "n/a"} icon={<BookUser size={20} />} />
